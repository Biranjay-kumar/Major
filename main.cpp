...
int main() {
    try {
        ...
        Scheduler scheduler = initializeScheduler();  // ✅ Correct
...
// Fix: initializeScheduler should RETURN a Scheduler, not void
Scheduler initializeScheduler() {
    ...
    return Scheduler(refuelThreshold, refuelX, refuelY);  // ✅ Correct
}
